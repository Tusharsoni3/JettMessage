...
interface SignupFormProps {
  ...
  validationErrors: AuthFormErrors // <-- 1. Add this to the interface
  isValid: boolean
...
export default function SignupForm({
  formState,
  errors,
  validationErrors, // <-- 2. Destructure it here
  isValid,
  isSubmitting = false,
  apiError,
  onFieldChange,
  ...
  return (
    ...
    >
      ...
      <Input
        ...
        error={formState.password.length > 0 ? validationErrors.password : errors.password}
      />
      ...
      <Input
        ...
        error={formState.confirmPassword.length > 0 ? validationErrors.confirmPassword : errors.confirmPassword}
      />
